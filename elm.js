...
var author$project$Main$init = {
	A: A2(
		...
		9,
		A2(elm$core$Array$repeat, 9, 2)),
	w: 0
};
var author$project$Main$O = 1;
var author$project$Main$changeTurn = function (symbol) {
	switch (symbol) {
		case 0:
			return 1;
		case 1:
		...
		switch (msg.$) {
			...
			default:
				...
				var grid = A2(
					...
					A2(elm$core$Array$repeat, 9, 2),
					A2(elm$core$Array$get, superN, grids));
				var newGrid = A3(elm$core$Array$set, n, model.w, grid);
				var newGrids = A3(elm$core$Array$set, superN, newGrid, grids);
				return _Utils_update(
					model,
					{
						A: newGrids,
						w: author$project$Main$changeTurn(model.w)
					});
		}
	});
...
var author$project$Main$symbolToHtml = function (symbol) {
	switch (symbol) {
		case 0:
			return A2(
				elm$html$Html$img,
...
var author$project$Main$compareSymbols = F3(
	function (x, y, z) {
		return _Utils_eq(x, y) && (_Utils_eq(x, z) && (x !== 2));
	});
var author$project$Main$checkWin = function (grid) {
	var e8 = A2(
		elm$core$Maybe$withDefault,
		2,
		A2(elm$core$Array$get, 8, grid));
	var e7 = A2(
		elm$core$Maybe$withDefault,
		2,
		A2(elm$core$Array$get, 7, grid));
	var e6 = A2(
		elm$core$Maybe$withDefault,
		2,
		A2(elm$core$Array$get, 6, grid));
	var e5 = A2(
		elm$core$Maybe$withDefault,
		2,
		A2(elm$core$Array$get, 5, grid));
	var e4 = A2(
		elm$core$Maybe$withDefault,
		2,
		A2(elm$core$Array$get, 4, grid));
	var e3 = A2(
		elm$core$Maybe$withDefault,
		2,
		A2(elm$core$Array$get, 3, grid));
	var e2 = A2(
		elm$core$Maybe$withDefault,
		2,
		A2(elm$core$Array$get, 2, grid));
	var e1 = A2(
		elm$core$Maybe$withDefault,
		2,
		A2(elm$core$Array$get, 1, grid));
	var e0 = A2(
		elm$core$Maybe$withDefault,
		2,
		A2(elm$core$Array$get, 0, grid));
	return A3(author$project$Main$compareSymbols, e0, e1, e2) ? e0 : (A3(author$project$Main$compareSymbols, e3, e4, e5) ? e3 : (A3(author$project$Main$compareSymbols, e6, e7, e8) ? e6 : (A3(author$project$Main$compareSymbols, e0, e3, e6) ? e0 : (A3(author$project$Main$compareSymbols, e1, e4, e7) ? e1 : (A3(author$project$Main$compareSymbols, e2, e5, e8) ? e2 : (A3(author$project$Main$compareSymbols, e0, e4, e8) ? e0 : (A3(author$project$Main$compareSymbols, e2, e4, e6) ? e2 : 2)))))));
};
var author$project$Main$Choose = F2(
	function (a, b) {
		return {$: 2, a: a, b: b};
	});
...
var author$project$Main$toNode = F3(
	function (grid, n, superN) {
		var _n0 = A2(elm$core$Array$get, n, grid);
		if (!_n0.$) {
			var symbol = _n0.a;
			if (symbol === 2) {
				return A2(
					...
					_List_fromArray(
						[
							elm$html$Html$Attributes$class('node emptyNode'),
							elm$html$Html$Events$onClick(
							A2(author$project$Main$Choose, n, superN))
						]),
					_List_fromArray(
						[
							author$project$Main$symbolToHtml(2)
						]));
			} else {
				var x_or_o = symbol;
				return A2(
					...
					_List_fromArray(
						[
							author$project$Main$symbolToHtml(x_or_o)
						]));
			}
		} else {
...
var author$project$Main$toGrid = F2(
	function (grid, n) {
		return A2(
			elm$html$Html$div,
			_List_fromArray(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							elm$html$Html$Attributes$class('line west')
						]),
					_List_Nil),
					A2(
					elm$html$Html$div,
...
var author$project$Main$toGridNode = F2(
	function (grid, n) {
		...
		if (!_n0.$) {
			var gridNode = _n0.a;
			var _n1 = author$project$Main$checkWin(gridNode);
			if (_n1 === 2) {
				return A2(author$project$Main$toGrid, gridNode, n);
			} else {
				var symbol = _n1;
				return author$project$Main$symbolToHtml(symbol);
			}
		} else {
			return elm$html$Html$text('');
		}
	});
var author$project$Main$toSuperGrid = function (grid) {
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						A2(author$project$Main$toGridNode, grid, 1 - 1)
					])),
				A2(
				elm$html$Html$div,
				_List_fromArray(
				...
				_List_fromArray(
					[
						A2(author$project$Main$toGridNode, grid, 2 - 1)
					])),
				A2(
				elm$html$Html$div,
				_List_fromArray(
				...
				_List_fromArray(
					[
						A2(author$project$Main$toGridNode, grid, 3 - 1)
					])),
				A2(
				elm$html$Html$div,
				_List_fromArray(
				...
				_List_fromArray(
					[
						A2(author$project$Main$toGridNode, grid, 4 - 1)
					])),
				A2(
				elm$html$Html$div,
				_List_fromArray(
				...
				_List_fromArray(
					[
						A2(author$project$Main$toGridNode, grid, 5 - 1)
					])),
				A2(
				elm$html$Html$div,
				_List_fromArray(
				...
				_List_fromArray(
					[
						A2(author$project$Main$toGridNode, grid, 6 - 1)
					])),
				A2(
				elm$html$Html$div,
				_List_fromArray(
				...
				_List_fromArray(
					[
						A2(author$project$Main$toGridNode, grid, 7 - 1)
					])),
				A2(
				elm$html$Html$div,
				_List_fromArray(
				...
				_List_fromArray(
					[
						A2(author$project$Main$toGridNode, grid, 8 - 1)
					])),
				A2(
				elm$html$Html$div,
				_List_fromArray(
				...
				_List_fromArray(
					[
						A2(author$project$Main$toGridNode, grid, 9 - 1)
					]))
			]));
};
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								author$project$Main$symbolToHtml(model.w)
							]))
					])),
				A2(
				elm$html$Html$div,
				...
				_List_fromArray(
					[
						author$project$Main$toSuperGrid(model.A)
					]))
			]));
};
